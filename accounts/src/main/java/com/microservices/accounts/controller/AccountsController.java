...
@Tag(name = "CRUD REST APIs for Accounts", description = "CRUD Rest API for Easy Bank Create, Update, Fetch and Delete")
@RestController
...
public class AccountsController {
        ...
        @Operation(summary = "Get Java version information", description = "Get java information that is deployed")
        @ApiResponses({
                        @ApiResponse(responseCode = "200", description = "HTTP Status OK"),
                        @ApiResponse(responseCode = "500", description = "HTTP Status Internal Server Error", content = @Content(schema = @Schema(implementation = ErrorResponseDto.class)))
        })
